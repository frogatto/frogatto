...
custom_object_type::custom_object_type(wml::const_node_ptr node, const custom_object_type* base_type)
  : id_(node->attr("id")),
	...
	static_object_(wml::get_bool(node, "static_object", use_image_for_collisions_)),
	has_feet_(wml::get_bool(node, "has_feet", true) && static_object_ == false),
	...
	hidden_in_game_(wml::get_bool(node, "hidden_in_game", false)),
