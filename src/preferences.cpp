...
#include "TargetConditionals.h"
...
#if !TARGET_OS_IPHONE && !TARGET_IPHONE_SIMULATOR
		controls::set_SDL_Keycode(controls::CONTROL_UP, static_cast<SDL_Keycode>(node["key_up"].as_int(SDLK_UP)));
		controls::set_SDL_Keycode(controls::CONTROL_DOWN, static_cast<SDL_Keycode>(node["key_down"].as_int(SDLK_DOWN)));
		controls::set_SDL_Keycode(controls::CONTROL_LEFT, static_cast<SDL_Keycode>(node["key_left"].as_int(SDLK_LEFT)));
		controls::set_SDL_Keycode(controls::CONTROL_RIGHT, static_cast<SDL_Keycode>(node["key_right"].as_int(SDLK_RIGHT)));
		controls::set_SDL_Keycode(controls::CONTROL_ATTACK, static_cast<SDL_Keycode>(node["key_attack"].as_int(SDLK_d)));
		controls::set_SDL_Keycode(controls::CONTROL_JUMP, static_cast<SDL_Keycode>(node["key_jump"].as_int(SDLK_a)));
		controls::set_SDL_Keycode(controls::CONTROL_TONGUE, static_cast<SDL_Keycode>(node["key_tongue"].as_int(SDLK_s)));
#endif
	}
	...
	void save_preferences()
	{
		...
		node.add("key_up", controls::get_SDL_Keycode(controls::CONTROL_UP));
		node.add("key_down", controls::get_SDL_Keycode(controls::CONTROL_DOWN));
		node.add("key_left", controls::get_SDL_Keycode(controls::CONTROL_LEFT));
		node.add("key_right", controls::get_SDL_Keycode(controls::CONTROL_RIGHT));
		node.add("key_attack", controls::get_SDL_Keycode(controls::CONTROL_ATTACK));
		node.add("key_jump", controls::get_SDL_Keycode(controls::CONTROL_JUMP));
		node.add("key_tongue", controls::get_SDL_Keycode(controls::CONTROL_TONGUE));
