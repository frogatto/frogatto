...
void custom_object_command_callable::set_expression(const game_logic::formula_expression* expr)
{
	expr_ = expr;
	expr_holder_.reset(expr);
}

void entity_command_callable::run_command(level& lvl, entity& obj) const
{
	if(expr_) {
//		try {
...
void custom_object_command_callable::run_command(level& lvl, custom_object& obj) const
{
	if(expr_) {
		try {
			fatal_assert_scope scope;
