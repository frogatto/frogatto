...
variant get_constant(const std::string& id)
{
	if(id == "DOUBLE_SCALE") {
		...
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_UP)));
	} else if(id == "DOWN_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_DOWN)));
	} else if(id == "LEFT_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_LEFT)));
	} else if(id == "RIGHT_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_RIGHT)));
	} else if(id == "JUMP_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_JUMP)));
	} else if(id == "TONGUE_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_TONGUE)));
	} else if(id == "ATTACK_KEY") {
		return variant(gui::get_key_name(controls::get_SDL_Keycode(controls::CONTROL_ATTACK)));
	} else if(id == "LOCALE") {
