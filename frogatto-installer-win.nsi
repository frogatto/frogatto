...
Section "Uninstall"
  ...
  StrCmp $INSTDIR $PROGRAMFILES 0 +41
    ...
    Delete "$INSTDIR\UbuntuMono-BI.ttf"
    Delete "$INSTDIR\UbuntuMono-R.ttf"
    Delete "$INSTDIR\UbuntuMono-RI.ttf"
