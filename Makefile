...
game: $(objects)
	g++ -g $(OPT) -L/sw/lib -L/usr/X11R6/lib -lprofiler -L. -lX11 -D_GNU_SOURCE=1 -D_REENTRANT -Wnon-virtual-dtor -Wreturn-type -L/usr/lib `sdl-config --libs` -lSDLmain -lSDL -lGL -lGLU -lGLEW -lSDL_image -lSDL_ttf -lSDL_mixer -lboost_regex-mt -lboost_system-mt -fthreadsafe-statics $(objects) -o game
