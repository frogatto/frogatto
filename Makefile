objects = background.o blur.o border_widget.o button.o character.o character_editor_dialog.o current_generator.o editor_dialogs.o editor_formula_functions.o editor_layers_dialog.o editor_stats_dialog.o editor_variable_info.o character_type.o collision_utils.o color_utils.o controls.o custom_object.o custom_object_functions.o custom_object_type.o debug_console.o dialog.o draw_number.o draw_scene.o draw_tile.o editor.o editor_level_properties_dialog.o entity.o filesystem.o fluid.o font.o formula.o formula_function.o formula_tokenizer.o frame.o framed_gui_element.o geometry.o graphical_font.o grid_widget.o group_property_editor_dialog.o gui_formula_functions.o gui_section.o image_widget.o input.o item.o item_type.o inventory.o joystick.o key.o label.o level.o level_logic.o level_object.o level_runner.o load_level.o main.o message_dialog.o movement_script.o multi_tile_pattern.o multiplayer.o options_dialog.o particle_system.o playable_custom_object.o player_info.o powerup.o preferences.o preprocessor.o preview_tileset_widget.o prop.o property_editor_dialog.o random.o raster.o raster_distortion.o solid_map.o sound.o speech_dialog.o stats.o status_gui.o string_utils.o surface_cache.o surface_formula.o surface_scaling.o surface.o texture.o text_entry_widget.o thread.o tile_map.o tileset_editor_dialog.o tooltip.o translate.o utils.o variant.o water.o weather_particle_system.o widget.o wml_formula_adapter.o wml_modify.o wml_node.o wml_parser.o wml_schema.o wml_utils.o wml_writer.o unit_test.o formula_test.o wml_parser_test.o
